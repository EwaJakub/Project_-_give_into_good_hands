...
urlpatterns = [
    ...
    path('edit-my-profile/', main_views.EditProfileView.as_view(), name='edit-my-profile'),
    path('change-password/', main_views.ResetPasswordView.as_view(), name='change-password'),
]
